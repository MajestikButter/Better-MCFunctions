...
</code></pre></div><h2 id="logic" tabindex="-1">Logic <a class="header-anchor" href="#logic" aria-hidden="true">#</a></h2><h3 id="if-condition-boolean-command-void" tabindex="-1"><code>if &lt;condition: boolean&gt; &lt;command&gt; : void</code> <a class="header-anchor" href="#if-condition-boolean-command-void" aria-hidden="true">#</a></h3><ul><li>Runs a command if the condition boolean is true</li></ul><div class="language-"><pre><code>
$condition = return true
if %{$condition} say condition passed

</code></pre></div><h3 id="issuccess-command-boolean" tabindex="-1"><code>issuccess &lt;command&gt; : boolean</code> <a class="header-anchor" href="#issuccess-command-boolean" aria-hidden="true">#</a></h3><ul><li>Returns true if the provided command runs successfully</li></ul><div class="language-"><pre><code>
$success = issuccess testfor @a
if %{$success} say hi

</code></pre></div><h3 id="return-argument-any-any" tabindex="-1"><code>return &lt;argument: any&gt; : any</code> <a class="header-anchor" href="#return-argument-any-any" aria-hidden="true">#</a></h3><ul><li>Returns the supplied argument, useful for variable assignments</li></ul><div class="language-"><pre><code>
$x = return 1
$example = return %{$x \\* 10}

</code></pre></div><h3 id="repeat-amount-number-command-void" tabindex="-1"><code>repeat &lt;amount: number&gt; &lt;command&gt; : void</code> <a class="header-anchor" href="#repeat-amount-number-command-void" aria-hidden="true">#</a></h3><ul><li>Repeats the supplied command the specified amount of times</li></ul><div class="language-"><pre><code>repeat 10 say hi
</code></pre></div>`,57),s=[o];function r(l,c,d,m,u,h){return n(),t("div",null,s)}var b=e(i,[["render",r]]);export{v as __pageData,b as default};
